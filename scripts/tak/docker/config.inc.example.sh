...
DATABASE_ALIAS="tak-database"   # Docker network alias
DATABASE_CONNECTIONS=2100       # Number of concurrent database connections
DOCKER_SUBNET="172.20.0.0/24"   # Docker subnet
